package com.zhilianxinke.schoolinhand.modules.maps;
...
/**
 * Created by hh on 2015-05-10.
 */
@SuppressLint("ClickableViewAccessibility")
public class SOSOLocationActivity extends MapActivity implements
        TencentLocationListener, View.OnClickListener, Handler.Callback, View.OnTouchListener {
    ...
    protected void onDestroy() {
        ...
        if (AppContext.getLastLocationCallback() != null)
            AppContext.getLastLocationCallback().onFailure("失败");

        AppContext.setLastLocationCallback(null);
        TencentLocationManager.getInstance(this).removeUpdates(this);
    ...
    public void onClick(View v) {
        ...
        if (mMsg != null) {
            AppContext.getLastLocationCallback().onSuccess(mMsg);
            AppContext.setLastLocationCallback(null);
            finish();
        } else {
            AppContext.getLastLocationCallback()
                    .onFailure("定位失败");
        }
