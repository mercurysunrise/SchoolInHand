...
import com.zhilianxinke.schoolinhand.modules.photos.adapters.AlbumGridViewAdapter;
import com.zhilianxinke.schoolinhand.modules.photos.util.AlbumHelper;
import com.zhilianxinke.schoolinhand.modules.photos.util.Bimp;
import com.zhilianxinke.schoolinhand.modules.photos.util.ImageBucket;
...
public class AlbumActivity extends BaseActivity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, AddNewsinfoActivity.class);
			startActivity(intent);
			finish();
		}
